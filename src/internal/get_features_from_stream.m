...
%GET_FEATURES_FROM_STREAM Summary of this function goes here
%   Detailed explanation goes here
    ...
    for streamid=1:length(stream)
        ...
        if strcmp(type, 'full') || strcmp(type, 'full-masked')
            ...
            featureIds = get_features_per_window(windows, feature.bbs);
...
function ids = get_features_per_window(windows, bboxes)
    min_overlap = 0.5;
